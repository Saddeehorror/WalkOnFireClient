-- CONFIG
APP_NAME = "Walk on Fire"  -- important, change it, it's name for config dir and files in appdata
...
Services = {
  ...
  updater = "https://github.com/Saddeehorror/WalkOnFireClient.git",
  stats = "",
  crash = "",
  feedback = "",
  status = ""
...
Servers = {
  WalkOnFire = "198.58.107.178:7171",
